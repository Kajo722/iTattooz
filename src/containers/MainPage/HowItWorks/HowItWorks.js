...
class HowItWorks extends Component {
    ...
    resize = () => {
        let currentWidth = window.innerWidth <= 1100;
                ...
                <div className={styles.container}>
                    <div className={styles.featureContainer}>
                        <Features
                            ...
                            <Feature>
                                Design your fully-personalized tattoo
                            </Feature>
                            <Feature>
                                Send the project directly to chosen artist
                            </Feature>
                        </Features>
                    </div>
                    <div className={styles.featureContainer}>
                        <Features
                            ...
                            imgSrc={img2}
                            alt={'Hands of two people drawing something on the paper'}>
                            <Feature>Arrange a metting with artist</Feature>
                            <Feature>Discuss the artwork</Feature>
                            <Feature>
                                Get the design draft prepared by designer
                            </Feature>
                        </Features>
                    </div>
                    <div className={styles.featureContainer}>
                        <Features
                            ...
                            alt={'Hand of tattoo artist with blue gloves making a tattoo'}>
                            <Feature>
                                Accept the final project or ask for corrections
                            </Feature>
                            <Feature>
                                Choose a suitable date for your session
                            </Feature>
                            <Feature>
                                Get the tattoo of your dreams designed by YOU!
                            </Feature>
                        </Features>
                    </div>
                </div>
